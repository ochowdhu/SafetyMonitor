...
// FORMULA: ['impprop', ['prop', 'perT10'], ['peventprop', 0, 89, ['prop', 'perT100']]]
#include "monconfig.h"
const int ftype[NFORMULAS] = { VALUE_T, VALUE_T, VALUE_T, PROP_T, PROP_T, PEVENT_T, IMPLIES_T, };
...
formulas[3].val.propMask = MASK_perT10;
formulas[4].type = PROP_T;
formulas[4].val.propMask = MASK_perT100;
formulas[4].structidx = 0;
formulas[5].type = PEVENT_T;
formulas[5].val.t_children.lchild = 4;
formulas[5].val.t_children.lbound = 0;
formulas[5].val.t_children.hbound = 89;
formulas[6].type = IMPLIES_T;
formulas[6].val.children.lchild = 3;
