...
traceDir2=../../akane_monitor/omarTraces/moreTraces
...
if [ $1 = "U3" ]; then
	build/pc-armMon "$traceDir2/U3-S-1.csv" 
	echo "@@@@ TRACE 1: Should be SATISFIED"
	build/pc-armMon "$traceDir2/U3-S-2.csv"
	echo "@@@@ TRACE 2: Should be SATISFIED"
	build/pc-armMon "$traceDir2/U3-S-3.csv"
	echo "@@@@ TRACE 3: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-4.csv"
	echo "@@@@ TRACE 4: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-5.csv"
	echo "@@@@ TRACE 5: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-6.csv"
	echo "@@@@ TRACE 6: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-7.csv"
	echo "@@@@ TRACE 7: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-8.csv"
	echo "@@@@ TRACE 8: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-9.csv"
	echo "@@@@ TRACE 9: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-10.csv"
	echo "@@@@ TRACE 10: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-11.csv"
	echo "@@@@ TRACE 11: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-12.csv"
	echo "@@@@ TRACE 12: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-13.csv"
	echo "@@@@ TRACE 13: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-14.csv"
	echo "@@@@ TRACE 14: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-15.csv"
	echo "@@@@ TRACE 15: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-16.csv"
	echo "@@@@ TRACE 16: Should be SATISFIED"
	./build/pc-armMon "$traceDir2/U3-S-17.csv"
	echo "@@@@ TRACE 17: Should be SATISFIED"

	echo "==========================================="
	echo "NOW, VIOLATED TRACES"
	./build/pc-armMon "$traceDir2/U3-V-1.csv"
	echo "!!!! TRACE 1: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-2.csv"
	echo "!!!! TRACE 2: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-3.csv"
	echo "!!!! TRACE 3: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-4.csv"
	echo "!!!! TRACE 4: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-5.csv"
	echo "!!!! TRACE 5: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-6.csv"
	echo "!!!! TRACE 6: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-7.csv"
	echo "!!!! TRACE 7: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-8.csv"
	echo "!!!! TRACE 8: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-9.csv"
	echo "!!!! TRACE 9: Should be VIOLATED"
	./build/pc-armMon "$traceDir2/U3-V-10.csv"
	echo "!!!! TRACE 10: Should be VIOLATED"
fi
